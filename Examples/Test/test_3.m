...
Az = 5e6;                                                  % Orbit amplitude out of the synodic plane. Play with it!
...
param = [Az Az 0 0 Ln gamma m];                             % Lyapunov orbit parameters
...
StableManifold = invariant_manifold(mu, Ln, manifold_ID, manifold_branch, lyapunov_orbit.Trajectory, rho, tspan);

manifold_ID = 'U';           % Unstable manifold (U or S)
manifold_branch = 'L';       % Left branch of the manifold (L or R)

UnstableManifold = invariant_manifold(mu, Ln, manifold_ID, manifold_branch, lyapunov_orbit.Trajectory, rho, tspan);
