...
% Test 13 is concerned with relative motion integration through MCPI
...
dynamics = @(t,s)(vnlr_model(mu, zeros(3,N+1), t.', s.').');
[tau, Sr, state] = MCPI([t0 tf], tau, repmat(s0,N+1,1), dynamics, N, 1e-12);
