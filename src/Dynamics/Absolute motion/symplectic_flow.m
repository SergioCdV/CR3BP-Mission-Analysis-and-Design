...
function [S, z] = symplectic_flow(mu, L, gamma, x, t)
    ...
    C(5,1) = (lambda^3+(1-c2)*lambda)/s(1);
    ...
    C(5,4) = (-lambda^3-(1-c2)*lambda)/s(1);
    C(1,5) = 2*omegap/s(2);
    ...
    z0(4,1) = x(4)-x(3);        %Synodic x momenta
    ...
    S(:,4) = (z(4,:)+z(3,:)).';     %Synodic x velocity
