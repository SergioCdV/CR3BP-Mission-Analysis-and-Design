...
% computes the magnitude of the velocity vector associated with a 
% particular Jacobi Constant and a specified position vector

% Inputs: - scalar mu, the reduced gravitational parameter of the system
%         - vector r, a position vector expressed in the non-dimensional
%           synodic frame
%         - scalar J, the associated Jacobi constan
