...
% the center manifold torus expansion of the relative dynamics

% Inputs: - scalar mu, the reduced gravitational parameter of the CR3BP
%           system
%         - scalar T, the initial orbit period
%         - scalar dtheta, the initial phase difference 
...
%% Auxiliary functions 
function [S, state, Tref] = QPP_guidance(mu, T, dtheta, K, s0, epsilon, tol)
    % Constants 
    ...
    % Computation of the initial monodromy matrix
