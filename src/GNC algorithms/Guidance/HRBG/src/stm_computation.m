...
function [STM] = stm_computation(mu, tf, St, n, P, B, sampling_distribution, basis, tau, method)
    switch (method)
        case 'Analytical'
            [STM] = analytical_STM(n, P, B, basis);
...
function [STM] = analytical_STM(n, P0, B, basis)
    % Constants 
