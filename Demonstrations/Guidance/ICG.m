...
%% GNC 14: Impulsive Center Manifold Guidance %% 
% This script provides an interface to test the ICG guidance core.
...
%Guidance trajectory
restriction = 'Center';
[Str, V, state(1)] = ICG_guidance(mu, Ln, gamma, 2, [r_t0 r_c0], tol, restriction);
St = Str(:,1:6)+Str(:,7:12);
